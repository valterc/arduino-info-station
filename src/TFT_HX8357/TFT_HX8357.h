...

{
 ...
 public:
  ...
  int16_t  drawChar(uint16_t uniCode, int16_t x, int16_t y, int16_t font),
           ...
           drawString(const char *string, int16_t poX, int16_t poY, int16_t font),
           drawCentreString(const char *string, int16_t dX, int16_t poY, int16_t font),
           drawRightString(const char *string, int16_t dX, int16_t poY, int16_t font),

           height(void),
           width(void),
           textWidth(const char *string, int16_t font),
